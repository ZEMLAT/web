...
# #### URL updates
# 
# NASDAQ updates the files occasionally so that the SOURCE_FILE changes. If the above gives an error, navigate to the FTP_URL using an ftp client like FileZilla or CyberDuck, open the `NASDAQ ITCH` directory and check for new files. As of September 2021, the listed files include:
# 
